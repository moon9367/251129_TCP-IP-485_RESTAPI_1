...
CONTROL_SPECS = {
    ...
    "roof_right_end_open_output_indicator": {
        "korean_name": "천장우단닫힘출력표시",
        "type": "BIT_READ",
        "address": 65,
        "bit": 9,
        "unit": "-",
        "description": "천장우단 닫힘출력 표시 (천장우단닫힘출력표시)"
    },

    "roof_right_open_output_indicator": {
        "korean_name": "천장우닫힘출력표시",
        "type": "BIT_READ",
        "address": 65,
        "bit": 8,
        "unit": "-",
        "description": "천장우 닫힘출력 표시 (천장우닫힘출력표시)"
    },

    "roof_left_end_open_output_indicator": {
        "korean_name": "천장좌단닫힘출력표시",
        "type": "BIT_READ",
        "address": 65,
        "bit": 7,
        "unit": "-",
        "description": "천장좌단 닫힘출력 표시 (천장좌단닫힘출력표시)"
    },

    "roof_left_open_output_indicator": {
        "korean_name": "천장좌닫힘출력표시",
        "type": "BIT_READ",
        "address": 65,
        "bit": 6,
        "unit": "-",
        "description": "천장좌 닫힘출력 표시 (천장좌닫힘출력표시)"
    },
